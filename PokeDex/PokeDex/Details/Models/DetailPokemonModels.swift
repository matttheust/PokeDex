...
// MARK: - Modelo Principal View Detalhes
...
struct APIPokemonDetailResponse: Decodable {
    ...
    let height: Int
    let weight: Int
    let sprites: PokemonSprites // De HomePokemonModels.swift
...
// TODO: Mapear API responses para PokemonFullDetails
